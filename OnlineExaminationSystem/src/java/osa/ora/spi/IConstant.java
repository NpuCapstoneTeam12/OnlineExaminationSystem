...
public interface IConstant {
    ...
    public static final String DATA_SOURCE_NAME = "jdbc:mysql://localhost:3306/exam";
    ...
    public static final String EMAIL_USER="keyurmulanig@gmail.com";
    public static final String EMAIL_PASSWORD="Keyur@786$";
