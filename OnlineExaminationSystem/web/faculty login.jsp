<!DOCTYPE html>
<html lang="en">
<head><title>Online Examination System | Home Page</title>
...
<div id="wrapper"><!-- HEADER-->
    <header class="header-wrapper">
        <div id="header">
            <div class="container">
                <div class="logo"><a href="index.html"><img src="assets/images/logo.png" alt="" class="img-responsive"/></a></div>
                <nav class="menu">
                    <ul class="list-unstyled list-inline">
                        <li class="active"><a href="index.html">Home</a></li>
                        <li class="dropdown"><a href="#" data-hover="dropdown" class="data-toggle">Introduction<span class="arrow fa fa-angle-down"></span></a>
                            <ul class="dropdown-menu multi-level">
                                <li><a href="about_us.html"><i class="fa fa-plus text-danger mrm"></i>About Us</a></li>
                                <li class="dropdown-submenu"><a href="services.html"><i class="fa fa-plus text-danger mrm"></i>Services</a>
        ...
        <div id="slider">
            <div id="banner-sliders" data-ride="carousel" class="carousel slide">
                <div class="carousel-inner">
                    <div class="item active"><img src="C:\Users\Raj\Desktop/Student-Loans-Website-Banner.jpg" alt=""/>

                        <div class="carousel-caption"></div>
                    </div>
                    <div class="item"><img src="C:\Users\Raj\Desktop/2.png" alt=""/>
                    </div>
                </div>
    ...
    <div class="login">
      ...
      <form method="post" action="index.html">
        ...
        <p class="submit"><input type="submit" name="commit" value="Login" color="blue"></p>
      </form>
    </div>
    ...
    <div id="footer">
        <div id="section-copyright">
            <div class="container"><p class="text-center mbn">© 2015 Npu Online Examination System. All Rights Reserved</p></div>
        </div>
    </div>
    </div>
</div>
